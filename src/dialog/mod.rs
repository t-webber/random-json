...
use crate::generator::{Fakers, Generator as _};
...
impl Dialog {
    ...
    pub fn generate(mut fakers: Fakers) -> Res<String> {
        let fakers_list = fakers.list();
        ...
        fakers_list[selection].generate(&mut fakers)
    }
}
